...
```json
{
    ...
    "is_proof_of_address_valid" : false,
    "land_use_permit" : "https://www.orimi.com/pdf-test.pdf",
    "is_land_use_permit_valid" : false,
    "bedrooms": [
        Bedroom(),
        Bedroom(),
    ],
...
| `is_proof_of_address_valid` | `Boolean` | Si es **False** Significa que el documento no ha sido validado.            |
| `land_use_permit`   | `String`     | URL del documento que acredita el uso de suelo de la propiedad.            |
| `is_land_use_permit_valid` | `Boolean` | Si es **False** Significa que el documento no ha sido validado.            |
